...
export const ContactForm = () => {
  ...
  const sendEmail = (e) => {
    ...
    // fmData.append("fullName", e.target.fullName.value);
    // fmData.append("phone", e.target.phone.value);
    // fmData.append("email", e.target.email.value);
    // fmData.append("message", e.target.message.value);
  ...
  return (
    <div className="bg-white">
      <div className="container mx-auto w-[90%] flex lg:flex-row flex-col  max-md:flex-col  ">
        <div className="w-[1/2] container  p-8">
