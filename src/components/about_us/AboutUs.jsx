    ...
    <div className="flex justify-between gap-10 container mx-auto w-[90%] mb-20 max-md:flex-col">
      <div className="w-1/2 max-md:w-full">
        ...
        <p className="text-secondary_color text-xl max-md:text-sm">
          ...
          birinchi navli undan ikkinchi va uchinchi navgacha eng sifatli bug'doy
          unini ishlab chiqarish va raqobatbardosh narxlarda hech kimdan kam
          bo'lmagan xizmat ko'rsatish uchun qurilgan. Ulgurji va ishlab
          chiqarish bozori sohasida 30 yildan ortiq tajribaga ega. Bizning
          xodimlarimiz o'zlarining tajriba va bilimlarini mijozlarga har kuni
          yangi mahsulotlarni to'plash yoki yetkazib berishga yordam berish
          uchun ishlatadilar.Ulgurji va ishlab chiqarish bozori sohasida 30
          yildan ortiq tajribaga ega. Bizning xodimlarimiz o'zlarining tajriba
          va bilimlarini mijozlarga har kuni{" "}
        </p>
      </div>
      <div
